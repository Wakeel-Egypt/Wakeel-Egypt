...
def handle_callback(client, callback_query):
    ...
    if data == "deposit" or data == "withdraw":
        ...
        # تحديد الرسالة المناسبة بناءً على نوع العملية
        transaction_type = user_data[chat_id]["transaction_type"]
        if transaction_type == "deposit":
            callback_query.message.reply("برجاء إختيار طريقة الإيداع :", reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("محفظة إلكترونية", callback_data="wallet")],
                [InlineKeyboardButton("إنستاباي", callback_data="instapay")]
            ]))
        elif transaction_type == "withdraw":
            callback_query.message.reply("برجاء إختيار طريقة السحب :", reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("محفظة إلكترونية", callback_data="wallet")],
                [InlineKeyboardButton("إنستاباي", callback_data="instapay")]
            ]))
